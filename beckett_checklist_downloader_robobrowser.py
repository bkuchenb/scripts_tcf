...
admin_page = browser.open('http://marketplace.beckett.com/admin')
#Get the login form.
login_form = admin_page.find('#loginFrm')
#Find the loginEmail text box.
loginEmail = login_form[0].find('#loginEmail')
#Enter loginEmail.
loginEmail[0]['value'] = ('dialcard@nycap.rr.com')

#Find the loginPassword text box.
password = login_form[0].find('#loginPassword')
